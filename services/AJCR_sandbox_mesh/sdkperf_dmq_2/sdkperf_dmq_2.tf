#
resource "solacebroker_msg_vpn_acl_profile" "sandbox-vpn_sdkperf_dmq_2_acl" {
  depends_on = [ solacebroker_msg_vpn.sandbox-vpn ]
  acl_profile_name                = "sdkperf_dmq_2_acl"
...
resource "solacebroker_msg_vpn_client_profile" "sandbox-vpn_sdkperf_dmq_2_cp" {
  depends_on = [ solacebroker_msg_vpn.sandbox-vpn ]
  allow_guaranteed_msg_receive_enabled                              = true
  allow_guaranteed_msg_send_enabled                                 = true
  client_profile_name                                               = "sdkperf_dmq_2_cp"
...
resource "solacebroker_msg_vpn_client_username" "sandbox-vpn_sdkperf_dmq_2" {
  acl_profile_name     = solacebroker_msg_vpn_acl_profile.sandbox-vpn_sdkperf_dmq_2_acl.acl_profile_name
  client_profile_name  = solacebroker_msg_vpn_client_profile.sandbox-vpn_sdkperf_dmq_2_cp.client_profile_name
  client_username      = "sdkperf_dmq_2"
  password             = var.sdkperf_dmq_2_user_password
  enabled              = true
  msg_vpn_name         = solacebroker_msg_vpn.sandbox-vpn.msg_vpn_name
